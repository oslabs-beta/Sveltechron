//content script in main execution context does not have access to the chrome api

// chrome.runtime.onConnect.addListener(function (port) {
//   console.log(port, 'connected in the contentMain');
//   port.onMessage.addListener(function (msg) {
//     console.log('message received in contentMain:', msg);
//   });
// });
console.log('contentMain fired');

// window.postMessage('window.postMessage worked in main');

// chrome.runtime.sendMessage('sendMessage worked in main ');
// window.postMessage({ message: 'knock knock' });
// chrome.runtime.addEventListener('click', () => console.log('click'));
// //MAIN WORLD
